...
if("TRUE" STREQUAL "TRUE")
  set(navfn_SOURCE_PREFIX /home/anton202/slam_study/src/navigation/navfn)
  set(navfn_DEVEL_PREFIX /home/anton202/slam_study/devel)
  set(navfn_INSTALL_PREFIX "")
  set(navfn_PREFIX ${navfn_DEVEL_PREFIX})
else()
  set(navfn_SOURCE_PREFIX "")
  set(navfn_DEVEL_PREFIX "")
  set(navfn_INSTALL_PREFIX /home/anton202/slam_study/install)
...
if(NOT "/home/anton202/slam_study/devel/include;/home/anton202/slam_study/src/navigation/navfn/include " STREQUAL " ")
  set(navfn_INCLUDE_DIRS "")
  set(_include_dirs "/home/anton202/slam_study/devel/include;/home/anton202/slam_study/src/navigation/navfn/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navfn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/anton202/slam_study/src/navigation/navfn/${idir}'.  ${_report}")
    endif()
